            ...
            <div class="container">
                <div class="row">
                    <div class="col l6 s12">
                        ...
                        <p class="grey-text text-lighten-4">Contact: <a href="mailto:support@intranetproject.net" style="color:white; text-decoration:underline;">support@intranetproject.net</a>
                        </p>
                    </div>
                    <div class="col l4 offset-l2 s12">
                        ...
                        <ul>
                            ...
                            </b> with <i style="color: red;">&hearts;</i> by <a class="grey-text text-lighten-3" href="https://github.com/IntranetProject">Intranet</a> and help from <a class="grey-text text-lighten-3" href="http://materializecss.com/">Materialize</a>
                                </p>
                            </li>
                        </ul>
                    </div>
