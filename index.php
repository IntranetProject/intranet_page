...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "url": "https://www.intranetproject.net",
      "name": "Intranetproject",
      "contactPoint": {
        "@type": "ContactPoint",
        "url": "https://intranetproject.net/support/index.php",
...
<body>
<div class="container z-depth-5 blue  " id="snow">
    <header>
    ...
    <main>
        ...
        <div class="row">
            <div class="col s10 offset-s1">
                <div id="info" class="card blue darken-1">
                    <div class="card-content white-text">
                        <span class="card-title">What is Intranet?</span><br><br>
                        <p class="explanation"><a href="https://en.wikipedia.org/wiki/Home_automation">SmartHomes</a>
                            are winning more and more popularity in the last couple of years. However these systems are
                            expensive and not controllable. To have everything in one application is a lot nicer. At
                            this point our Intranet comes to play. Our Intranet is OpenSource, module based
                            software-system, meaning you can configure everything as you like. There is the classic
                            setup, that doesn't contain a lot of features. Modules are the interesting part. Modules are
                            easy to install and expand your existing system. There are software modules, like a
                            TODO-List or calendar, but also hardware with software components, like temperature modules
                            or remotely controllable power plugs. These have hardware components, which can be purchased
                            in our shop. <br><br> Our Goal is to create a perfect system with what you and your family
                            can perfectly organize yourselves. We want to give everyone the opportunity to "build" their
                            very own SmartHome.<br><br> For Hobbyists we transfer all data for the hardware (mostly
                            circuit boards and other components) OpenSource to <a
                                    href="https://github.com/IntranetProject">GitHub</a>. With the data you can build
                            the modules yourself. We offer all tools you need to start your own SmartHome. We hope that
                            a community will come together and program more modules!</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col s10 offset-s1">
                <div class="card blue darken-1 white-text z-depth-1">
                    ...
                    <div class="card-content blue darken-1 team">
                        <div id="test4"><img class="circle" src="pic/tobi.jpg" width="50px" height="50px"/>
                            <h5>Tobi</h5>
                            <p>My name is Tobias. I'm 17 years old and I live in Germany. I'm a front-end developer
                                since 2016. Bennet and I have worked together on our own organization <a
                                        href="https://github.com/BaFrInds">BaFrInds</a> and many other projects.</p>
                        </div>
                        <div id="test5">
                            <img class="circle" src="pic/bennet.png" width="50px" height="50px"/>
                            <h5>Bennet</h5>
                            <p>My name is Bennet. I'm 17 years old and I live in Germany. I'm a front- and back-end
                                developer since 2015. Tobias and I have worked together on our own organization <a
                                        href="https://github.com/BaFrInds">BaFrInds</a> and many other projects.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col s10 offset-s1 m5">
                <div class="card blue darken-1 white-text">
                    ...
                    <div class="card-content">
                        <p>This is a picture of the settings page. Here you can configure your personal settings e.g.
                            user accounts.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col s10 offset-s1 m10 offset-m1">
                <div class="card-panel blue darken-1 z-depth-1 commits white-text">
                ...
                <div class="card blue darken-1">
                    <div class="card-content white-text">
                        ...
                        <p>You can download the newest software versions via the link below.<br><br>
                            <b>Important:</b><br>We do not promise that the Beta builds are bug free!<br>Be sure that
                            these versions might not work and could result in Data loss!</p>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">Contact: <a href="mailto:support@intranetproject.net"
                                                                style="color:white; text-decoration:underline;">support@intranetproject.net</a>
                </p>
            </div>
